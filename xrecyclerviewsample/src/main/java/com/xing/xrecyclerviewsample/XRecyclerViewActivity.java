...
public class XRecyclerViewActivity extends AppCompatActivity implements XRecyclerView.LoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("XRecyclerViewActivity");
